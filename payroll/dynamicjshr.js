		...
		$(Mydiv).empty();
			...
			$(html).appendTo(Mydiv);
				...
				if(url=='individualemployeeallowances' || url=='individualemployeedeductionss'){
				    ...
				    $(tablee).DataTable({
					  "responsive": true,"bLengthChange": false,"bFilter": false,"bInfo": false,"autoWidth": false,"bPaginate": false,pageLength: 7,
					...
					$(tablee).DataTable({
					  "responsive": true, "lengthChange": false,"bDestroy": true,"aaSorting": [[ 2, 'desc' ]] , "autoWidth": false,pageLength: 7,
...
$(document).ready(function() {
	...
	$("#payrolltable").DataTable({
					  "responsive": true,"bLengthChange": false,"bFilter": false,"aaSorting": [[ 2, 'desc' ]] ,"bInfo": false,"bPaginate": false,pageLength: 7,
					  	  'columnDefs' : [{ 'visible': false, 'targets': [0]},{
					 'render': function ( data, type, row ){							 	 	
						 return '';
					 }}]
