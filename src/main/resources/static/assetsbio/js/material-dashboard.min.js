...
function darkMode(el) {
  ...
  const all_modal = document.querySelectorAll('div.modal-content');   
  const all_article = document.querySelectorAll('article.leaderboard__profile');
  const leaderboard = document.getElementById('listemployeeseditpayslip');  
  ...
  if (el==1) {
	...
	if(leaderboard){		
		leaderboard.classList.add('dark-version');
	}
	
	for (var i = 0; i < all_modal.length; i++) {
      all_modal[i].classList.add('dark-version');
    }
	
	for (var i = 0; i < all_article.length; i++) {
      all_article[i].classList.add('dark-version');
    }
	...
	if(leaderboard){		
		leaderboard.classList.remove('light');
	}
	
	for (var i = 0; i < all_modal.length; i++) {
      all_modal[i].classList.remove('light');
    }
	
	for (var i = 0; i < all_article.length; i++) {
      all_article[i].classList.remove('light');
    }
