package com.rickiey_innovates.juditonspringapp.models.sms;
...
public class AccModel {
	...
	public static JSONObject dbaction(String query, int type, int allowduplicates, int clearexistingdata,int colcase) {
				
		JSONObject  alldat = new JSONObject();
		
		 int countBills = 0;
		 int allBills=0;	
		 List<String> collumns = new ArrayList<>();
	     List<AccModel> itemsnew =new ArrayList<AccModel>();
	     List<AccModel> datanew =new ArrayList<AccModel>();
...
// convert cols to lower case  ========================
					...
					if(colcase==1) {
						...
						while (rs.next()) {
							...
							AccModel row = new AccModel(collumns);
...
//  no convertin cols to lower case  ========================
		...
		alldat.put("countBills", countBills);
		alldat.put("allBills", allBills);
		alldat.put("collumns", collumns);
		alldat.put("itemsnew", itemsnew);
		alldat.put("datanew", datanew);
		alldat.put("json", json);
		alldat.put("jsondata", jsondata);
		alldat.put("response", response);
		alldat.put("liststring", liststring);
	...
	@SuppressWarnings("unchecked")
	public static JSONObject dbactionprepared(PreparedStatement query, int type, int allowduplicates, int clearexistingdata,int colcase) {
...
//  no convertin cols to lower case  ========================
	...
	public static String dbactiondirectaction(String query, int type, int allowduplicates, int clearexistingdata,int colcase) {
	...
	public AccModel(List<String> companyGroups) {
