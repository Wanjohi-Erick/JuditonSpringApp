...
public class PendingPO {
    int poItemsId, poId, itemId;
    String company, expectedDate, itemName, quantity, quantityReceived, outstanding;
    public PendingPO(int poItemsId, int poId, String company, String expectedDate, int itemId, String itemName, String quantity, String quantityReceived, String outstanding) {
